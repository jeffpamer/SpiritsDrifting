define([
    ...
    'backbone',
    'audioController'
], function($, _, Backbone, AudioController) {

    var init = function() {

        console.log("DO WE HAVE ACCESS TO THE AudioController?", AudioController);
        console.log("IS IT PLAYING?", AudioController.isPlaying());
    ...
    var render = function() {
        ...
        // TODO: Iterate views and render each
